...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'EmployerProfile'
        db.create_table('employer_employerprofile', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(related_name='employerprofile', unique=True, to=orm['auth.User'])),
            ('phone_number', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('business_name', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('business_address1', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ...
            ('business_phone_number', self.gf('django.db.models.fields.CharField')(max_length=20, blank=True)),
            ('business_website_url', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('business_description', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
        db.send_create_signal('employer', ['EmployerProfile'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'EmployerProfile'
        db.delete_table('employer_employerprofile')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'EmployerProfile.demo'
        db.add_column('employer_employerprofile', 'demo', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'EmployerProfile.demo'
        db.delete_column('employer_employerprofile', 'demo')

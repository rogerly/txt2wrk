...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('sms_sms', (
            ...
            ('applicant', self.gf('django.db.models.fields.related.ForeignKey')(related_name='sms_messages', null=True, to=orm['applicant.ApplicantProfile'])),
            ('action_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('sent_by_us', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('message', self.gf('django.db.models.fields.CharField')(max_length=160, blank=True)),
            ('sms_sid', self.gf('django.db.models.fields.CharField')(max_length=34, blank=True)),
            ('phone_number', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('message_type', self.gf('django.db.models.fields.IntegerField')(default=102)),
        ))
    ...
    models = {
        ...
        'sms.sms': {
            ...
            'applicant': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'sms_messages'", 'null': 'True', 'to': "orm['applicant.ApplicantProfile']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'message': ('django.db.models.fields.CharField', [], {'max_length': '160', 'blank': 'True'}),
            'message_type': ('django.db.models.fields.IntegerField', [], {'default': '102'}),
            'phone_number': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'sent_by_us': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'sms_sid': ('django.db.models.fields.CharField', [], {'max_length': '34', 'blank': 'True'})
        }
    }

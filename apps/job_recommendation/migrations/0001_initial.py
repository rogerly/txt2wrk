...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('job_recommendation_jobrecommendation', (
            ...
            ('applicant', self.gf('django.db.models.fields.related.ForeignKey')(related_name='recommendations', to=orm['applicant.ApplicantProfile'])),
    ...
    models = {
        ...
        'job_recommendation.jobrecommendation': {
            ...
            'applicant': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'recommendations'", 'to': "orm['applicant.ApplicantProfile']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),

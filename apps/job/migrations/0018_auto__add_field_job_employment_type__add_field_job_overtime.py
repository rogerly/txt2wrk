...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Job.employment_type'
        db.add_column('job_job', 'employment_type', self.gf('django.db.models.fields.IntegerField')(default=1, null=True), keep_default=False)

        # Adding field 'Job.overtime'
        db.add_column('job_job', 'overtime', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Job.employment_type'
        db.delete_column('job_job', 'employment_type')

        # Deleting field 'Job.overtime'
        db.delete_column('job_job', 'overtime')

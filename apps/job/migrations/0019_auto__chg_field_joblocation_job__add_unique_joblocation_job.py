...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'JobLocation.job'
        db.alter_column('job_joblocation', 'job_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['job.Job']))

        # Adding unique constraint on 'JobLocation', fields ['job']
        db.create_unique('job_joblocation', ['job_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'JobLocation', fields ['job']
        db.delete_unique('job_joblocation', ['job_id'])

        # Changing field 'JobLocation.job'
        db.alter_column('job_joblocation', 'job_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['job.Job']))

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Job.longitude'
        db.alter_column('job_job', 'longitude', self.gf('django.db.models.fields.CharField')(max_length=15, null=True))

        # Changing field 'Job.latitude'
        db.alter_column('job_job', 'latitude', self.gf('django.db.models.fields.CharField')(max_length=15, null=True))


    def backwards(self, orm):
        
        # Changing field 'Job.longitude'
        db.alter_column('job_job', 'longitude', self.gf('django.db.models.fields.CharField')(max_length=5, null=True))

        # Changing field 'Job.latitude'
        db.alter_column('job_job', 'latitude', self.gf('django.db.models.fields.CharField')(max_length=5, null=True))

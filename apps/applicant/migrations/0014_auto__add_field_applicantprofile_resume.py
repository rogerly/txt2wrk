...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ApplicantProfile.resume'
        db.add_column('applicant_applicantprofile', 'resume', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ApplicantProfile.resume'
        db.delete_column('applicant_applicantprofile', 'resume')

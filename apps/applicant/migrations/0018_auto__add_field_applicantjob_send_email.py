...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ApplicantJob.send_email'
        db.add_column('applicant_applicantjob', 'send_email', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ApplicantJob.send_email'
        db.delete_column('applicant_applicantjob', 'send_email')
    ...
    models = {
        'applicant.applicantjob': {
            ...
            'date_submitted': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 10, 3)'}),

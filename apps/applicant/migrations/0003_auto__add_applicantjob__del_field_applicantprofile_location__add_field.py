...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('applicant_applicantjob', (
            ...
            ('date_submitted', self.gf('django.db.models.fields.DateField')(default=datetime.date(2011, 7, 3))),
        ...
        # Adding field 'ApplicantProfile.latitude'
        db.add_column('applicant_applicantprofile', 'latitude', self.gf('django.db.models.fields.CharField')(max_length=5, null=True), keep_default=False)

        # Adding field 'ApplicantProfile.longitude'
        db.add_column('applicant_applicantprofile', 'longitude', self.gf('django.db.models.fields.CharField')(max_length=5, null=True), keep_default=False)
        ...
        # Renaming column for 'ApplicantProfile.experience' to match new field type.
        db.rename_column('applicant_applicantprofile', 'experience_id', 'experience')
        # Changing field 'ApplicantProfile.experience'
        db.alter_column('applicant_applicantprofile', 'experience', self.gf('django.db.models.fields.IntegerField')())

        # Removing index on 'ApplicantProfile', fields ['experience']
        db.delete_index('applicant_applicantprofile', ['experience_id'])

        # Renaming column for 'ApplicantProfile.availability' to match new field type.
        db.rename_column('applicant_applicantprofile', 'availability_id', 'availability')
        # Changing field 'ApplicantProfile.availability'
        db.alter_column('applicant_applicantprofile', 'availability', self.gf('django.db.models.fields.IntegerField')())

        # Removing index on 'ApplicantProfile', fields ['availability']
        db.delete_index('applicant_applicantprofile', ['availability_id'])

        # Renaming column for 'ApplicantProfile.education' to match new field type.
        db.rename_column('applicant_applicantprofile', 'education_id', 'education')
        # Changing field 'ApplicantProfile.education'
        db.alter_column('applicant_applicantprofile', 'education', self.gf('django.db.models.fields.IntegerField')())

        # Removing index on 'ApplicantProfile', fields ['education']
        db.delete_index('applicant_applicantprofile', ['education_id'])


    def backwards(self, orm):
        
        # Adding index on 'ApplicantProfile', fields ['education']
        db.create_index('applicant_applicantprofile', ['education_id'])

        # Adding index on 'ApplicantProfile', fields ['availability']
        db.create_index('applicant_applicantprofile', ['availability_id'])

        # Adding index on 'ApplicantProfile', fields ['experience']
        db.create_index('applicant_applicantprofile', ['experience_id'])
        ...
        # Deleting field 'ApplicantProfile.latitude'
        db.delete_column('applicant_applicantprofile', 'latitude')

        # Deleting field 'ApplicantProfile.longitude'
        db.delete_column('applicant_applicantprofile', 'longitude')

        # Removing M2M table for field jobs on 'ApplicantProfile'
        db.delete_table('applicant_applicantprofile_jobs')

        # Renaming column for 'ApplicantProfile.experience' to match new field type.
        db.rename_column('applicant_applicantprofile', 'experience', 'experience_id')
        # Changing field 'ApplicantProfile.experience'
        db.alter_column('applicant_applicantprofile', 'experience_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['job.Experience']))

        # Renaming column for 'ApplicantProfile.availability' to match new field type.
        db.rename_column('applicant_applicantprofile', 'availability', 'availability_id')
        # Changing field 'ApplicantProfile.availability'
        db.alter_column('applicant_applicantprofile', 'availability_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['job.Availability']))

        # Renaming column for 'ApplicantProfile.education' to match new field type.
        db.rename_column('applicant_applicantprofile', 'education', 'education_id')
        # Changing field 'ApplicantProfile.education'
        db.alter_column('applicant_applicantprofile', 'education_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['job.Education']))

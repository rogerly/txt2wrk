...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ApplicantProfile.distance'
        db.add_column('applicant_applicantprofile', 'distance', self.gf('django.db.models.fields.IntegerField')(default=5), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ApplicantProfile.distance'
        db.delete_column('applicant_applicantprofile', 'distance')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ApplicantJob.state'
        db.add_column('applicant_applicantjob', 'state', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ApplicantJob.state'
        db.delete_column('applicant_applicantjob', 'state')

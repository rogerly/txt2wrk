...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ApplicantProfile.zip_code'
        db.add_column('applicant_applicantprofile', 'zip_code', self.gf('django.db.models.fields.CharField')(max_length=10, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ApplicantProfile.zip_code'
        db.delete_column('applicant_applicantprofile', 'zip_code')

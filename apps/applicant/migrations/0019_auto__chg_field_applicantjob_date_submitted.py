...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ApplicantJob.date_submitted'
        db.alter_column('applicant_applicantjob', 'date_submitted', self.gf('django.db.models.fields.DateTimeField')())


    def backwards(self, orm):
        
        # Changing field 'ApplicantJob.date_submitted'
        db.alter_column('applicant_applicantjob', 'date_submitted', self.gf('django.db.models.fields.DateField')())
    ...
    models = {
        'applicant.applicantjob': {
            ...
            'date_submitted': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 10, 3, 15, 39, 6, 198807)'}),

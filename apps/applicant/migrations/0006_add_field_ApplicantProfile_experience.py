...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('applicant_applicantprofile', 'experience', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ApplicantProfile.experience'
        db.delete_column('applicant_applicantprofile', 'experience')

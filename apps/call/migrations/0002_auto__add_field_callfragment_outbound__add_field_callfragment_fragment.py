...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CallFragment.outbound'
        db.add_column('call_callfragment', 'outbound', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Adding field 'CallFragment.fragment_type'
        db.add_column('call_callfragment', 'fragment_type', self.gf('django.db.models.fields.IntegerField')(default=1001), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CallFragment.outbound'
        db.delete_column('call_callfragment', 'outbound')

        # Deleting field 'CallFragment.fragment_type'
        db.delete_column('call_callfragment', 'fragment_type')
